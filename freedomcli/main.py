"""FreedomCLI - AI chat powered by OpenRouter.

This is the entry point module. All functionality has been split into
dedicated sub-modules for better maintainability.
"""
...
def main():
    parser = argparse.ArgumentParser(description="FreedomCLI - AI chat")
    parser.add_argument("--version", action="version", version=f"FreedomCLI v{APP_VERSION}")
    ...
    try:
        from freedomcli.ui import check_for_updates
