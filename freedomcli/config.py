"""Configuration management, encryption, and token counting."""
...
def _get_config_dir() -> str:
    """Get the user configuration directory for FreedomCLI."""
    # Use XDG config directory or fallback to ~/.config
    config_home = os.environ.get('XDG_CONFIG_HOME', os.path.join(os.path.expanduser('~'), '.config'))
    config_dir = os.path.join(config_home, 'freedomcli')
